...
import { assets, facilityIcons, roomCommonData, roomsDummyData,userDummyData,hotelDummyData } from '../assets/assets'
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div>
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
                <div className='lg:w-1/2 w-full'>
                 <img src={mainImage}  alt="Room Images" 
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                    {room.amenities.map((item,index)=>(
                        <div key={index} className='flex items-center gab-2 px-3 py-2 rounded-lg bg-gray-100'>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>
                ...
                ground floor according to availability.You get a comfortable two bedroom
