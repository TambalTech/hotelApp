...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title='My Bookings' subTitle='Easily manage your past, current, and upcomming hotel reservations in one
        place, Plan your trips seamlessly with just a few clicks' align='left'/>
        ...
        {bookings.map((booking)=>(
            ...
            py-6 first:border-t'>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    ...
                    {!booking.isPaid && (
                        <button className='px-4 py-1.5 mt-4 text-xs border border-b-gray-400 rounded-full hover:bg-gray-50
